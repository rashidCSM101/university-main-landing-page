...
const Admissions = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Admissions 2026-27 | GDC Larkana - Apply Now</title>
        <meta name="description" content="Admissions open at Government Degree College Larkana for BS Zoology, Botany, Chemistry & Intermediate programs. Check eligibility, fees & important dates." />
        <link rel="canonical" href="https://gdclarkana.edu.pk/admissions" />
      </Helmet>
