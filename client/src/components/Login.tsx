    ...
    <div ref={pageRef} className="min-h-screen flex">
      ...
      <div className="login-left hidden lg:flex lg:w-[45%] relative bg-gradient-to-br from-gray-900 via-gray-800 to-primary-dark items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-16 w-72 h-72 bg-primary rounded-full blur-3xl" />
          <div className="absolute bottom-16 right-10 w-96 h-96 bg-blue-500 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative z-10 max-w-md px-10 text-center">
          <Link to="/" className="inline-flex items-center gap-3 mb-10">
            ...
            <span className="text-2xl font-heading font-bold text-white">GDC Larkana</span>
          </Link>

          <h2 className="text-3xl font-heading font-bold text-white mb-4">Welcome Back!</h2>
          <p className="text-white/60 leading-relaxed mb-10">
            Access your student portal, view results, manage your courses, and stay updated with everything happening at Government Degree College Larkana.
          </p>
      ...
      {/* Right Panel — Form */}
      <div className="login-right w-full lg:w-[55%] flex items-center justify-center bg-gray-50 px-6 py-28">
        <div className="w-full max-w-md">
          ...
          <div className="inline-flex items-center gap-2 bg-primary/5 border border-primary/10 rounded-full px-4 py-1.5 mb-5">
            ...
            <span className="text-primary font-semibold text-xs uppercase tracking-wider">Student Portal</span>
          </div>
          ...
          {/* Google */}
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 rounded-xl py-3 text-sm font-medium text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all">
