          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-900">
                Research <span className="text-[#008B8B]">Library</span>
              </h2>
            </div>
                ...
                >
                  <div>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                      <div className="flex flex-wrap items-center gap-2">
                        <span className="text-xs font-bold px-3 py-1 rounded-full bg-[#008B8B]/10 text-[#008B8B] border border-[#008B8B]/30">
                          {pub.category}
                        </span>
                        {pub.is_open_access && (
                    ...
                    {/* Title */}
                    <h3 className="text-xl md:text-2xl font-heading font-bold text-gray-900 mb-3 group-hover:text-[#008B8B] transition-colors leading-snug">
                      {pub.title}
                    </h3>
                  ...
                  <div className="pt-4 border-t border-gray-100 flex flex-wrap items-center justify-between gap-4">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-semibold text-[#008B8B] hover:text-teal-700 bg-teal-50 px-3 py-2 rounded-xl transition-colors"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 py-2.5 px-5 bg-[#008B8B] text-white font-bold rounded-xl hover:bg-teal-700 transition-colors text-xs shadow-md"
                    >
