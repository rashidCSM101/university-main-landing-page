    ...
    <AuthProvider>
      <ToastProvider>
        <Router basename="/admin">
          ...
          {/* Media & Content Manager — All authenticated users (Admin / Super Admin / Member) */}
          <Route
            path={`${OBFUSCATED_ADMIN_PATH}/media`}
            element={
              <ProtectedRoute>
                <AdminLayout title="Media & Content Hub">
                  <MediaManager />
                </AdminLayout>
              </ProtectedRoute>
            }
          ...
          {/* Publications & Research Papers Manager — All authenticated users */}
          <Route
            path={`${OBFUSCATED_ADMIN_PATH}/publications`}
            element={
              <ProtectedRoute>
                <AdminLayout title="Research & Publications">
                  <PublicationsManager />
                </AdminLayout>
              </ProtectedRoute>
            }
